...
/// Controls how page execution contexts are discovered.
///
/// Persistent mode is chromiumoxide's historical behavior and enables the
/// Runtime domain for the lifetime of every target. On-demand mode avoids a
/// persistent Runtime domain and resolves contexts only when an operation
/// requires one.
...
pub struct HandlerConfig {
    ...
    /// How execution contexts are discovered for attached targets.
