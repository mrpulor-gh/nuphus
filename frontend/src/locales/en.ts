...
[
  ...
  'tools.ability.imageResizeDesc': 'Scale proportionally to target size, preserving aspect ratio',
  ...
  'tools.ability.voiceCloneDesc':
    'Synthesize speech with a reference voice (cloud; configure a voice-clone model in Model settings)',
