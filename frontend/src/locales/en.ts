const en: Record<string, string> = {
  ...
  'memory.annotation.guide':
    'Record project relationships here so Nuphus instantly understands context when different projects are mentioned. Add annotations with keywords — the system will auto-inject relevant hints when those keywords appear in conversation.',
