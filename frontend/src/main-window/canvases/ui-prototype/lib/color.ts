...
export type SchemeOptions = {
  dark?: boolean
  contrast?: Contrast
  /** keep a muted seed muted instead of lifting it to a vivid accent */ keepChroma?: boolean
}
...
function tonesFor(dark: boolean, contrast: Contrast): Tones {
  ...
  if (contrast === 'medium') {
    if (dark)
      Object.assign(t, {
        primary: 85,
        onPrimaryContainer: 95,
        onSecondaryContainer: 95,
        onTertiaryContainer: 95,
        onSurfaceVariant: 85,
        outline: 70,
        outlineVariant: 50,
      })
    ...
    if (dark)
      Object.assign(t, {
        ...
        secondaryContainer: 80,
        onSecondaryContainer: 0,
        tertiaryContainer: 80,
      ...
      Object.assign(t, {
        primary: 20,
        primaryContainer: 30,
        onPrimaryContainer: 100,
        secondaryContainer: 30,
        onSecondaryContainer: 100,
        tertiaryContainer: 30,
        onTertiaryContainer: 100,
        onSurface: 0,
        onSurfaceVariant: 10,
        outline: 20,
        outlineVariant: 20,
