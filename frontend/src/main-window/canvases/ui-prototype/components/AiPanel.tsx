      ...
      <div style={{ padding: '0 4px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          <div>
            ...
            <Input
              label={t('aiBaseUrl', lang)}
              value={settings.baseUrl}
              onChange={baseUrl => onSettings({ ...settings, baseUrl })}
          ...
          <div>
            ...
            <Input
              label={t('aiKey', lang)}
              value={settings.key}
              onChange={key => onSettings({ ...settings, key })}
              placeholder="sk-…"
              p={p}
              type="password"
            />
