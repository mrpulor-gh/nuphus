...
use crate::desktop_automation::{Observation, SemanticLocator, UiNode};
            ...
            StateCondition::ValueEquals if !node.secure => node
                ...
                .map(|(actual, expected)| {
                    ...
                    let expected = if node
                        .supported_actions
                        .contains(&crate::desktop_automation::NativeAction::SetRangeValue)
                    {
                    ...
                    actual == &crate::desktop_automation::value_fingerprint(expected)
                }),
            _ => None,
        };
        match matched {
